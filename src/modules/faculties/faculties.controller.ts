...
import { CreateFacultyDto, UpdateFacultyDto, FacultyParamsIDDto, FacultyPublicParamDto } from './dto';
...
export class FacultiesController {
  ...
  @Get("public")
  async getPublic(@Query() query: FacultyPublicParamDto) {
    return this.facultiesService.getPublic(query?.university_id);
  }
  ...
  @Patch(':id')
  update(
    @Param() params: FacultyParamsIDDto,
